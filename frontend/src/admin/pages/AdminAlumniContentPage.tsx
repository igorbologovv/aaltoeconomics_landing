...
import AdminSiteContentAlumniEditorSection from "../components/admin_site_content/AdminSiteContentAlumniEditorSection";
...
function AdminAlumniContentPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setContent(data as SiteContent);
      setSaveMessage("Alumni content saved successfully.");
    } catch (error) {
      setErrorMessage(
  ...
  if (errorMessage && !content) {
    return (
      <section className="admin-site-content-page-state">
        <div className="container">
          <h1>Could not load Alumni content</h1>
          <p>{errorMessage}</p>
        </div>
      </section>
    );
    ...
    <>
      ...
      <div className="admin-site-content-layout">
        <div className="container">
          ...
          <AdminSiteContentAlumniEditorSection
            content={content}
...
export default AdminAlumniContentPage;