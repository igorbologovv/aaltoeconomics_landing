...
import AdminSiteContentJoinUsEditorSection from "../components/admin_site_content/AdminSiteContentJoinUsEditorSection";
...
function AdminJoinUsContentPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setContent(data as SiteContent);
      setSaveMessage("Join Us content saved successfully.");
    } catch (error) {
      setErrorMessage(
  ...
  if (errorMessage && !content) {
    return (
      <section className="admin-site-content-page-state">
        <div className="container">
          <h1>Could not load Join Us content</h1>
          <p>{errorMessage}</p>
        </div>
      </section>
    );
    ...
    <>
      ...
      <div className="admin-site-content-layout">
        <div className="container">
          ...
          <AdminSiteContentJoinUsEditorSection
            content={content}
...
export default AdminJoinUsContentPage;